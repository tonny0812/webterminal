...
var ChatRoom = function(httpserver) {
  this.init(httpserver);
  this.onlineUser = {};
};

ChatRoom.prototype.init = function(httpserver) {
  //var app = require('http').createServer(this.router);
  this.io = socketio(httpserv,{path: '/chat/socket.io'});
...
module.exports = function(httpserver) {
    return new ChatRoom(httpserver);
}
